...
const MonthNavigation = ({ monthNames, currentPage, setCurrentPage, activeTab, activeBookings, historyBookings, bookings }) => {
  return (
    <div className="fixed bottom-0 left-0 right-0 md:left-64 bg-white border-t border-gray-200 shadow-lg z-5 px-4 py-3 flex justify-between items-center gap-4">
      <button
