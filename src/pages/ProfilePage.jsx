    ...
    try {
      ...
      bookingsData.forEach((booking) => {
        ...
        const isRecentlyRejected =
          booking.status === "rejected" && statusUpdatedAt > oneHourAgo;
        if (
                ...
                {activeBookings.length > 0 ? (
                            ...
                            <div className="p-3 bg-white">
                              ...
                              {booking.status === "confirmed" && (
                                <div className="mt-3 p-2 bg-green-50 rounded-lg border border-green-100 text-sm text-green-700">
                                  ...
                                  <p className="text-xs mt-1">
                                    Silahkan datang sesuai jadwal. Kami
                  ...
                  <div className="py-4 flex flex-col items-center justify-center">
                    ...
                    <p className="text-gray-500 text-center max-w-md">
                      Saat ini Anda tidak memiliki booking yang sedang aktif.
                      Booking aktif akan muncul di sini ketika Anda membuat
                      reservasi baru.
                    </p>
                    <div className="mt-6 inline-flex items-center px-4 py-2 bg-purple-50 border border-purple-100 rounded-lg text-sm text-purple-700">
                      ...
                      Booking yang menunggu konfirmasi, terkonfirmasi, atau
                      ditolak akan ditampilkan di sini
                    </div>
                  </div>
                )}
              </div>
