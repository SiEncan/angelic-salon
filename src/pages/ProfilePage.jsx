      ...
      <div className="bg-gradient-to-br from-pink-100 via-purple-100 to-pink-300 min-h-screen">
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="flex justify-center items-center h-[70vh]">
            <div className="animate-pulse text-purple-500 text-xl">Loading profile...</div>
          </div>
        </div>
      </div>
    )
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 md:col-span-1">
              <div className="flex flex-col items-center">
                ...
                <h2 className="text-xl font-bold">{profile?.displayName || user.displayName || "Customer"}</h2>
                <p className="text-gray-500 mb-4">{user.email}</p>

                <div className={`${rankClass} px-4 py-2 rounded-full flex items-center gap-2 font-semibold`}>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 md:col-span-2">
              <h3 className="text-xl font-bold mb-4">Membership Rank</h3>
                ...
                <div className="bg-purple-50 rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="min-w-4 mt-0.5">•</div>
                      <span>
                        <strong>Gold:</strong> 15% discount + free mini treatment
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="min-w-4 mt-0.5">•</div>
                      <span>
                        <strong>Platinum:</strong> 20% discount + priority booking
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="min-w-4 mt-0.5">•</div>
                      <span>
                        <strong>Diamond:</strong> 25% discount + VIP treatment + exclusive offers
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 md:col-span-3">
              ...
              {bookings.length > 0 ? (
                    ...
                    <tbody>
                      {bookings.map((booking) => (
                        <tr key={booking.id} className="border-b border-gray-100">
                          <td className="py-3">{booking.service || booking.serviceName}</td>
                ...
                <div className="text-center py-8 text-gray-500">
                  ...
                  <button className="mt-4 bg-purple-100 text-purple-700 hover:bg-purple-200 transition px-4 py-2 rounded-lg font-medium">
